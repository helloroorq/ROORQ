...
**Campus delivery. Zero hassle.**
You don't pack, ship, or coordinate. ROORQ handles delivery within the IIT Roorkee campus. You hand over the item, we do the rest.
...
Drops are not random. They're curated batches, which means your item is presented alongside other quality pieces — not buried in a feed of noise.
...
| What | Details |
|------|---------|
| Commission | 10% of the final sale price (ROORQ's cut) |
| You receive | 90% of what the buyer pays |
| Payout timeline | Within **7 days** of confirmed delivery |
| Payout method | UPI transfer directly to your registered account |

**No upfront fees. No listing charges. You only pay commission when you sell.**

Payment to the buyer is collected at doorstep — Cash on Delivery or UPI — so there's no waiting on bank transfers or payment gateway delays.

---

## What Makes a Great Listing

The better your listing, the faster your item sells. Here's what to get right:
...
### Title
Be specific. Not "Blue Hoodie" — write "Nike Tech Fleece Hoodie – Navy, Size M."
...
**1. Go to [roorq.in/vendor](https://roorq.in/vendor)**
Create your vendor account using your IITR email or phone number.

**2. Complete your profile**
Add your name, UPI ID for payouts, and WhatsApp number (for order coordination).

**3. Submit your first product**
...
**6. Drop goes live**
Your item is now visible to buyers. Track views and order status in real time on your vendor dashboard.

**7. Order placed**
When a buyer orders, you'll get a WhatsApp notification. Prepare the item for handover as instructed.

**8. Delivery & payout**
ROORQ collects from the buyer and transfers your 90% cut within 7 days of confirmed delivery.

---

## After You List: What Happens Next
...
| Delivered | Buyer confirmed delivery — payout initiated |
| Paid | UPI transfer sent to your account |

You can check your product's current stage any time from the **vendor dashboard** at roorq.in/vendor.
...
*ROORQ — Pre-loved, not secondhand. There's a difference.*
